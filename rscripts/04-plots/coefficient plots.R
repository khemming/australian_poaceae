...
# individual plot function ---------------------------------------
  coef_plot <- function(dat, subtribe, x_mn, x_mx, brks, r2_i){
    r2_t <- parse(text = r2_i)[[1]]
    r2_lab <- bquote(italic(.("R")^2)~"="~.(r2_t))
...
# All C3 & C4
# Neo and Paleo C3
# Endemic C3 Paniceae and native C3 Paniceae
...
# Neo and Paleo C3
  coef_v1("Neo-Paleo C3", 
          "Neo C3",
          "Paleo C3",
          c(-3.1, 1.6), 
          c(round(seq(-3.0, 1.5, 1.5), digits = 2)))
  
#  Endemic C3 Paniceae and native C3 Paniceae
  coef_v1("Endemic-Native C3 Paniceae", 
          "Endemic C3 Paniceae",
          "Native C3 Paniceae",
          c(-1.25, 1.5), 
          c(round(seq(-1, 1.5, 0.5), digits = 2)))
