...
# data ---------------------------------------------------------------------   
# sub tribes
  st_pv <- read.csv("results/supplementary materials/species/species pv 1146.csv") %>%
...
# save ---------------------------------------
  write.csv(m_mat, "data/supplementary materials/species Morans I.csv", row.names = T)
  write.csv(gls_mat2, "data/supplementary materials/species GLS model structures.csv", row.names = T)
  
  save.image("data/supplementary materials/species gls model data.RData")
