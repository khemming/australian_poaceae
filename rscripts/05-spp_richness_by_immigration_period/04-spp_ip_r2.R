...
# subtribe iNEXT richness
  st <- read.csv("results/supplementary materials/species/species pv 1146.csv") %>% 
...
# save
  write.csv(r2, "results/supplementary materials/species/r2.csv", row.names = F)
